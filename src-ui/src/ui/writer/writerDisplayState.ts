    ...
    ? [
        {
          ...
          percent: pct(budgetReport.system_tokens),
          tokens: budgetReport.system_tokens || 0,
          color: "bg-error/70",
        },
        ...((budgetReport.p2_tokens || 0) > 0
          ? [
              {
                key: "recent",
                label: t("writer.memoryLayer.recentChapter"),
                percent: pct(budgetReport.p2_tokens),
                tokens: budgetReport.p2_tokens || 0,
                color: "bg-info/70",
              },
            ]
          : []),
        ...((budgetReport.p3_tokens || 0) > 0
          ? [
              {
                key: "facts",
                label: t("writer.memoryLayer.facts"),
                percent: pct(budgetReport.p3_tokens),
                tokens: budgetReport.p3_tokens || 0,
                color: "bg-accent/70",
              },
            ]
          : []),
        ...((budgetReport.p4_tokens || 0) > 0
          ? [
              {
                key: "rag",
                label: t("writer.memoryLayer.rag"),
                percent: pct(budgetReport.p4_tokens),
                tokens: budgetReport.p4_tokens || 0,
                color: "bg-success/70",
              },
            ]
          : []),
        ...((budgetReport.p5_tokens || 0) > 0
          ? [
              {
                key: "settings",
                label: t("writer.memoryLayer.characterSettings"),
                percent: pct(budgetReport.p5_tokens),
                tokens: budgetReport.p5_tokens || 0,
                color: "bg-warning/70",
              },
            ]
          : []),
