...
export const AuLoreLayout = ({
  ...
  const sharedModals = (
    <AuLoreModals
      ...
      handleCreate={() => {
        void actions.createFile(modals.createName);
      }}
      deleteConfirmOpen={modals.isDeleteConfirmOpen}
      closeDeleteConfirm={modals.closeDeleteConfirm}
      selectedFile={selectedFile}
      handleDeleteLore={() => {
        void actions.deleteCurrentFile();
      }}
                ...
                {selectedFile ? (
                  ...
                  <>
                    <Button
                      ...
                      disabled={isSaving}
                      title={t("common.actions.importFromFandom")}
                    >
                      <Download size={16} />
                    </Button>
                    <Button
  ...
  return (
    <>
      <div className="w-[300px] md:w-[340px] shrink-0 border-r border-black/10 dark:border-white/10 flex flex-col bg-surface/50">
        ...
        <div className="flex-1 min-h-0 flex flex-col">
          ...
          {files.length > 0 &&
            ...
            shouldShowMilestone("pin_intro") &&
            !modals.pinMilestoneDismissed && (
              <MilestoneGuide
      ...
      <div className="flex-1 flex flex-col bg-background relative">
        ...
        <div className="flex-1 overflow-y-auto p-6 w-full flex flex-col gap-6">{editorPanel}</div>
      </div>
