...
export interface ChapterSummaryRepository {
  get(au_id: string, chapter_num: number): Promise<ChapterSummary | null>;
  save(au_id: string, chapter_num: number, summary: ChapterSummary): Promise<void>;
  remove(au_id: string, chapter_num: number): Promise<void>;
   ...
   */
  update_micro(au_id: string, chapter_num: number, text: string, hash: string): Promise<void>;
   ...
   */
  promote_to_v2(au_id: string, chapter_num: number, v2_text: string, hash: string): Promise<void>;
}
