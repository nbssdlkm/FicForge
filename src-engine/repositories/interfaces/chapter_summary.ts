...
export interface ChapterSummaryRepository {
   ...
   */
  updateMicro(au_id: string, chapter_num: number, text: string, hash: string): Promise<void>;
   ...
   */
  promoteToV2(au_id: string, chapter_num: number, v2_text: string, hash: string): Promise<void>;
}
